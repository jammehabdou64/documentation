    ...
    <DocLayout>
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <p>
            jcc-express-starter provides a variety of helper functions to make
            common tasks easier. These helpers are globally available throughout
            your application and can be used without requiring any imports.
          </p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p>
                Returns the fully qualified path to the application's base
                directory with the given path appended.
              </p>
              <CodeHighLight>
...
const configPath = base_path('config/app.ts');`}
            ...
            <div>
              ...
              <p>
                Returns the fully qualified path to the application's app
                directory with the given path appended.
              </p>
              <CodeHighLight>
...
const userModelPath = app_path('Models/User.ts');`}
            ...
            <div>
              ...
              <p>
                Returns the fully qualified path to the application's config
                directory with the given path appended.
              </p>
              <CodeHighLight>
...
const dbConfigPath = config_path('database.ts');`}
            ...
            <div>
              ...
              <p>
                Returns the fully qualified path to the application's public
                directory with the given path appended.
              </p>
              <CodeHighLight>
...
const cssPath = public_path('css/app.css');`}
            ...
            <div>
              ...
              <p>
                Returns the fully qualified path to the application's storage
                directory with the given path appended.
              </p>
              <CodeHighLight>
...
const usersUrl = url('users');`}
            ...
            <div>
              ...
              <p>
                Generates a URL for an asset using the current scheme of the
                request (HTTP or HTTPS).
              </p>
              <div className="relative rounded-md bg-muted p-4 mt-2">
                <pre className="text-sm">
                  <code>
...
const userUrl = route('users.show', { id: 1 });`}
          ...
          <div className="space-y-4">
            <div>
              ...
              <p>
                Creates a collection from the given items, providing useful
...
// Returns: 15`}
            ...
            <div>
              <h4 className="font-medium">
                data_get(object, path, defaultValue)
              </h4>
...
dd('Debug message', { key: 'value' }, [1, 2, 3]);`}
          ...
          <p>
            You can create your own custom helpers by adding them to a{" "}
            <code>helpers.ts</code> file in your application. Here's an example
            of how to create and use custom helpers:
          </p>
...
// Returns: 25`}
          ...
          <p>
            Make sure to import your <code>helpers.ts</code> file in your
            application's entry point (e.g., <code>bootstrap/app.ts</code>) to
