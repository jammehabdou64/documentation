    ...
    <DocLayout>
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <p>
            `jcc-eloquent` is an ORM for Node.js designed to provide
            Eloquent-style features and database interaction. It simplifies
            complex queries and supports models, relationships, mass assignment,
            and events.
          </p>
          ...
          <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
            ...
            <li>
              Attribute casting with casts and hidden properties for sensitive
              fields
            </li>
            <li>Event hooks for lifecycle methods (booted, creating, etc.)</li>
            <li>
              QueryBuilder with chainable methods like select, where, orderBy,
              and pagination
            </li>
          </ul>
          ...
          <p>
            Define models with properties like fillable, guarded, hidden, casts,
            and event hooks.
          </p>
      ...
      message: await Post.find(req.params.id),
          ...
          <div className="space-y-4">
            <div>
              ...
              <p>
                Retrieves all records from the database table associated with
                the current model.
              </p>
...
console.log(users);`}
            ...
            <div>
              ...
              <p>
                Retrieves a single record from the database table associated
                with the current model by its ID.
              </p>
...
console.log(user);`}
            ...
            <div>
              ...
              <p>
                Creates one or more records in the database table associated
...
console.log(users);`}
            ...
            <div>
              ...
              <p>
                Saves the current instance to the database. If the instance has
                an id, it performs an update; otherwise, it performs an insert.
              </p>
